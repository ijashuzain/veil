...
class $AssetsAppIconGen {
  ...
  /// File path: assets/app_icon/veil_app_icon.png
  AssetGenImage get veilAppIcon =>
      const AssetGenImage('assets/app_icon/veil_app_icon.png');

  /// List of all assets
  List<AssetGenImage> get values => [veilAppIcon];
}
